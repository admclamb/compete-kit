...
This is separate from the production webhook endpoint (`https://competekit.dev/api/webhooks/clerk`), which is registered once against the Clerk production instance.
