...
export default function Navbar() {
  return (
    <nav className="fixed inset-x-0 top-4 z-50 px-4">
      <div className="max-w-6xl py-3 mx-auto grid grid-cols-2 md:grid-cols-3 gap-3 px-6 rounded-full border bg-background/60 shadow-lg backdrop-blur-md">
        <Logo />
        ...
        <ul className="justify-self-end flex row-reverse md:row items-center gap-2 md:gap-3">
          ...
          <Show when="signed-in">
            <li className="hidden md:flex md:items-center">
              <UserButton
                appearance={{ elements: { userButtonBox: "flex items-center" } }}
              />
            </li>
          </Show>
          <li>
